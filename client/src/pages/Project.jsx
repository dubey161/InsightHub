    ...
    return (
        <div className='min-h-screen max-w-4xl mx-auto flex justify-center items-center flex-col gap-6 p-6'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-6">
                {/* Project 1 */}
                <div className="bg-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-lg cursor-pointer transform hover:scale-105 transition duration-300">
                ...
                {/* Project 2 */}
                <div className="bg-gray-200 rounded-lg overflow-hidden shadow-md cursor-pointer hover:shadow-lg transform hover:scale-105 transition duration-300">
